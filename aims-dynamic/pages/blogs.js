...
export default function Blogs() {
  const posts = [
    ...
    { title: "Estate Tax Sunset: Why Planning Early Matters", date: "Sep 2025", summary: "What 2026 sunset could mean and practical moves to prepare.", href: "https://www.linkedin.com/in/anilaimsfin/" }
  ];
  return (
    <div>
