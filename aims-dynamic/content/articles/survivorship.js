...
export const content = (
  <>
    <h3>What it is</h3>
    <p>
      Survivorship (second‑to‑die) policies insure two lives and pay a single death
      benefit after both insureds have passed away. They are usually structured as
      permanent life insurance (whole or universal) to guarantee the benefit.
    </p>
    ...
    <ul>
      <li>
        Often owned by an ILIT to keep proceeds outside the taxable estate and fund
        estate taxes.
      </li>
      <li>
        Can be paired with charitable remainder or lead trusts to amplify
