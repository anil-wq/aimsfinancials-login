...
export const content = (
  <>
    <h3>What it is</h3>
    <p>
      A Life Insurance Retirement Plan (LIRP) is not a qualified retirement
      plan but a strategy that uses the cash value of a permanent life
      insurance policy to supplement retirement income. You pay premiums with
    ...
    <ul>
      <li>
        Costs can be high in early years due to mortality charges and policy
        expenses; careful design is needed to maximize efficiency.
      </li>
      <li>
        If the policy lapses or becomes a MEC, withdrawals or loans may be
